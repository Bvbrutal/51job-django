...
!function(a) {
    ...
    a.extend(b.prototype, {
        ...
        placement: function() {
            ...
            1 == this.settings.newest_on_top && (c = parseInt(c) + parseInt(this.settings.spacing) + this.$ele.outerHeight(),
            this.reposition(c)),
            ...
            this.settings.delay > 0) {
                ...
                var c = setInterval(function() {
                    ...
                    if ("false" === b.$ele.data("data-hover") && "pause" == b.settings.mouse_over || "pause" != b.settings.mouse_over) {
                        ...
                        b.$ele.find('[data-notify="progressbar"] > div').attr("aria-valuenow", d).css("width", d + "%")
                    }
                    a <= -b.settings.timer && (clearInterval(c),
                    b.close())
                }, b.settings.timer)
            }
        },
        close: function() {
            ...
            this.$ele.one(this.animations.start, function(a) {
                ...
                a(this).remove(),
                a.isFunction(b.settings.onClosed) && b.settings.onClosed.call(this)
            }),
            setTimeout(function() {
                d || (b.$ele.remove(),
        ...
        reposition: function(b) {
            ...
            e.each(function() {
                ...
                b = parseInt(b) + parseInt(c.settings.spacing) + a(this).outerHeight()
            })
        }
    }),
